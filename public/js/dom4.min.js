...
(function(e) {
    ...
    for (
        var o,
            ...
            p =
                ...
                function(e, t, n) {
                    return (
                        h.call(n, "value")
                            ? (e[t] = n.value)
                            : (h.call(n, "get") && e.__defineGetter__(t, n.get), h.call(n, "set") && e.__defineSetter__(t, n.set)),
                        e
                    );
                },
            d =
            ...
            F = function(e) {
                ...
                return function(n) {
                    ...
                    if (f) {
                        for (
                            s = this.getAttribute("id") || y, o = s === y ? s : s.replace(B, j), a = n.split(","), i = 0;
                            i < a.length;
                            i++
                        )
                            a[i] = "#" + o + " " + a[i];
        ...
        (u = q[U - 2]),
            ...
            /^(?:before|after|replace|replaceWith|remove)$/.test(u) &&
                (k && !(u in L) && (L[u] = q[U - 1]), A && !(u in O) && (O[u] = q[U - 1]));
    ...
    P && I(P.prototype),
        ...
        (function() {
            for (
                var t, n = e.requestAnimationFrame, r = e.cancelAnimationFrame, i = ["o", "ms", "moz", "webkit"], s = i.length;
                !r && s--;

            )
                (n = n || e[i[s] + "RequestAnimationFrame"]),
                    (r = e[i[s] + "CancelAnimationFrame"] || e[i[s] + "CancelRequestAnimationFrame"]);
            r ||
                (n
                    ? ((t = n),
                      (n = function(e) {
    ...
    try {
        ...
        (z = (function(t) {
            function a(e) {
                for (
                    var t = [],
                        n = ["ctrlKey", "Control", "shiftKey", "Shift", "altKey", "Alt", "metaKey", "Meta", "altGraphKey", "AltGraph"],
                        r = 0;
                    r < n.length;
                    r += 2
                )
    ...
    (function(e) {
        ...
        function r(e, t, n) {
            function i(e) {
                i.once && (e.currentTarget.removeEventListener(e.type, t, i), (i.removed = !0)),
                    i.passive && (e.preventDefault = r.preventDefault),
                    typeof i.callback == "function" ? i.callback.call(this, e) : i.callback && i.callback.handleEvent(e),
        ...
        var i = e.CustomEvent,
            ...
            d;
        try {
            u("_", l, { once: !0 }), o(new i("_")), o(new i("_")), a("_", l, { once: !0 });
        } catch (v) {}
        f !== 1 &&
            (function() {
                function s(e) {
                    return function(s, o, u) {
                        if (u && typeof u != "boolean") {
                            ...
                            a || i.set(this, (a = new n())),
                                ...
                                l < 0 ? ((l = p.handler.push(o) - 1), (p.wrap[l] = d = new n())) : (d = p.wrap[l]),
                                f in d || ((d[f] = r(s, o, u)), e.call(this, s, d[f], d[f].capture));
