...
!(function(i, t) {
    "object" == typeof exports && "object" == typeof module
        ? (module.exports = t())
        : "function" == typeof define && define.amd ? define([], t) : "object" == typeof exports ? (exports.Flux = t()) : (i.Flux = t());
})(this, function() {
    return (function(i) {
        function t(s) {
        ...
        function(i, t, n) {
            ...
            (t.__esModule = !0),
                ...
                (a = (function() {
                    ...
                    return (
                        (i.prototype.register = function(i) {
                        ...
                        (i.prototype.waitFor = function(i) {
                            var t, n;
                            for (this._isDispatching ? void 0 : e(!1), t = 0; t < i.length; t++)
                                (n = i[t]),
                                    this._isPending[n]
                                        ? this._isHandled[n] ? void 0 : e(!1)
                                        : (this._callbacks[n] ? void 0 : e(!1), this._invokeCallback(n));
                        }),
