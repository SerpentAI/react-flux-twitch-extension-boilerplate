(function webpackUniversalModuleDefinition(root, factory) {
    if (typeof exports === "object" && typeof module === "object")
        module.exports = factory(require("React"), require("window"), require("classNames"), require("ReactDOM"), require("Tether"), require("ReactTransitionGroup.CSSTransitionGroup"));
    else if (typeof define === "function" && define.amd)
        define(["React", "window", "classNames", "ReactDOM", "Tether", "ReactTransitionGroup.CSSTransitionGroup"], factory);
    else if (typeof exports === "object")
        exports["Core"] = factory(require("React"), require("window"), require("classNames"), require("ReactDOM"), require("Tether"), require("ReactTransitionGroup.CSSTransitionGroup"));
    else
        (root["Blueprint"] = root["Blueprint"] || {}), (root["Blueprint"]["Core"] = factory(root["React"], root["window"], root["classNames"], root["ReactDOM"], root["Tether"], root["ReactTransitionGroup.CSSTransitionGroup"]));
})(this, function(
	...
	***************************************************************************** */
	 ...
	 */
                    ...
                    function throttleReactEventCallback(callback, options) {
                        ...
                        var throttledFunc = _throttleHelper(
                            function(event2) {
	 ...
	 */
                ...
                exports.CONTEXTMENU_WARN_DECORATOR_NO_METHOD =
                ...
                exports.MENU_WARN_CHILDREN_SUBMENU_MUTEX =
                ...
                exports.POPOVER_WARN_DOUBLE_CONTENT =
                ...
                exports.RADIOGROUP_WARN_CHILDREN_OPTIONS_MUTEX =
	 ...
	 */
                ...
                function getAttachmentClasses(position) {
                    ...
                    return expandAttachmentClasses(getPopoverAttachment(position), "pt-tether-element-attached").concat(
	 ...
	 */
                ...
                var position_1 = __webpack_require__(14);
                var utils_1 = __webpack_require__(8);
                var popover_1 = __webpack_require__(26);
                var TETHER_OPTIONS = {
	 ...
	 */
                ...
                var Utils = __webpack_require__(8);
                var isDarkTheme_1 = __webpack_require__(32);
                var overlay_1 = __webpack_require__(33);
                var tooltip_1 = __webpack_require__(36);
                var Arrows = __webpack_require__(37);
                var SVG_SHADOW_PATH =
                ...
                var Popover = (function(_super) {
                    ...
                    Popover.prototype.render = function() {
                        ...
                        targetProps.className = classNames(
                            ...
                            ((_a = {}), (_a[Classes.POPOVER_OPEN] = isOpen), _a),
                            className
                        );
                    ...
                    Popover.prototype.renderPopover = function(content) {
                        ...
                        var popoverClasses = classNames(
                            Classes.POPOVER,
                            ((_c = {}), (_c[Classes.DARK] = this.props.inheritDarkTheme && this.hasDarkParent && !inline), _c),
                        ...
                        return React.createElement(
                            "div",
                            { className: containerClasses, ref: this.refHandlers.popover, style: styles.container },
                            React.createElement(
                                "div",
                                tslib_1.__assign({ className: popoverClasses, style: transform }, popoverHandlers),
                                React.createElement(
                                    "div",
                                    { className: Classes.POPOVER_ARROW, style: styles.arrow },
                                    React.createElement(
                                        "svg",
                                        { viewBox: "0 0 30 30" },
                        ...
                        if (this.state.isOpen && !this.props.inline && this.popoverElement != null) {
                            ...
                            var options =
                                constraints == null && !useSmartPositioning
                                    ? tetherOptions
                                    : tslib_1.__assign({}, tetherOptions, {
            ...
            /***/ function(module, exports, __webpack_require__) {
                ...
                function pureRenderDecorator(component) {
                    if (component.prototype.shouldComponentUpdate !== undefined) {
                        ...
                        warning(
                            false,
                            "Cannot decorate `%s` with @pureRenderDecorator, " + "because it already implements `shouldComponentUpdate().",
	 ...
	 */
                ...
                var PureRender = __webpack_require__(27);
                var React = __webpack_require__(7);
                var CSSTransitionGroup = __webpack_require__(34);
                var Classes = __webpack_require__(17);
                var Keys = __webpack_require__(18);
                var utils_1 = __webpack_require__(8);
                var portal_1 = __webpack_require__(35);
                var Overlay = (Overlay_1 = (function(_super) {
                    ...
                    Overlay.prototype.render = function() {
                        ...
                        var transitionGroup = React.createElement(ReactTransitionGroup.CSSTransitionGroup, { transitionAppear: true, transitionAppearTimeout: transitionDuration, transitionEnterTimeout: transitionDuration, transitionLeaveTimeout: transitionDuration, transitionName: transitionName }, this.maybeRenderBackdrop(), isOpen ? decoratedChildren : null);
                        var mergedClassName = classNames(
                            Classes.OVERLAY,
                            ((_b = {}), (_b[Classes.OVERLAY_OPEN] = isOpen), (_b[Classes.OVERLAY_INLINE] = inline), _b),
                            className
                        );
                        var elementProps = {
                        ...
                        if (inline) {
                            return React.createElement(
                                "span",
                                tslib_1.__assign({}, elementProps, { ref: this.refHandlers.container }),
                                transitionGroup
                            );
                        } else {
                            return React.createElement(
                                portal_1.Portal,
                                tslib_1.__assign({}, elementProps, {
                    ...
                    Overlay.prototype.maybeRenderBackdrop = function() {
                        ...
                        if (hasBackdrop && isOpen) {
                            return React.createElement(
                                "div",
                                tslib_1.__assign({}, backdropProps, {
                ...
                var Portal = (function(_super) {
                    ...
                    Portal.prototype.componentDidUpdate = function() {
                        ...
                        ReactDOM.unstable_renderSubtreeIntoContainer(
                            ...
                            React.createElement(
                                "div",
                                tslib_1.__assign({}, props_1.removeNonHTMLProps(this.props), { ref: this.props.containerRef }),
                                this.props.children
                            ),
                            this.targetElement,
                            function() {
	 ...
	 */
                ...
                var errors_1 = __webpack_require__(10);
                var buttons_1 = __webpack_require__(39);
                var dialog_1 = __webpack_require__(43);
                ...
                var Alert = (function(_super) {
                    ...
                    Alert.prototype.render = function() {
                        ...
                        return React.createElement(
                            dialog_1.Dialog,
                            { className: classNames(common_1.Classes.ALERT, className), isOpen: isOpen, style: style },
                            React.createElement(
                                "div",
                                { className: common_1.Classes.ALERT_BODY },
                            ...
                            React.createElement(
                                "div",
                                { className: common_1.Classes.ALERT_FOOTER },
	 ...
	 */
                ...
                var React = __webpack_require__(7);
                var props_1 = __webpack_require__(15);
                var abstractButton_1 = __webpack_require__(40);
                var Button = (function(_super) {
                    ...
                    Button.prototype.render = function() {
                        return React.createElement(
                            "button",
                            tslib_1.__assign({ type: "button" }, props_1.removeNonHTMLProps(this.props), this.getCommonButtonProps()),
                            this.renderChildren()
                        );
                    };
                    return Button;
                ...
                var AnchorButton = (function(_super) {
                    ...
                    AnchorButton.prototype.render = function() {
                        ...
                        return React.createElement(
                            "a",
                            tslib_1.__assign({ role: "button" }, props_1.removeNonHTMLProps(this.props), commonProps, {
	 ...
	 */
                ...
                var utils_1 = __webpack_require__(8);
                var icon_1 = __webpack_require__(41);
                var spinner_1 = __webpack_require__(42);
                var AbstractButton = (function(_super) {
                    ...
                    AbstractButton.prototype.renderChildren = function() {
                        ...
                        return [
                            loading
                                ? React.createElement(spinner_1.Spinner, { className: "pt-small pt-button-spinner", key: "spinner" })
                                : undefined,
                ...
                var Icon = (Icon_1 = (function(_super) {
                    ...
                    Icon.prototype.render = function() {
                        ...
                        var classes = classNames(
                            ...
                            common_1.Classes.iconClass(iconName),
                            common_1.Classes.intentClass(intent),
                            className
                        );
                ...
                var Spinner = (function(_super) {
                    ...
                    Spinner.prototype.render = function() {
                        ...
                        return this.renderContainer(
                            ...
                            React.createElement(
                                "svg",
                                { viewBox: classes.indexOf(Classes.SMALL) >= 0 ? "-15 -15 130 130" : "0 0 100 100" },
	 ...
	 */
                ...
                var Dialog = (function(_super) {
                    ...
                    Dialog.prototype.render = function() {
                        return React.createElement(
                            overlay_1.Overlay,
                            tslib_1.__assign({}, this.props, { className: Classes.OVERLAY_SCROLL_CONTAINER, hasBackdrop: true }),
                            React.createElement(
                                "div",
                                { className: Classes.DIALOG_CONTAINER, onMouseDown: this.handleContainerMouseDown },
                                React.createElement(
                                    "div",
                                    { className: classNames(Classes.DIALOG, this.props.className), style: this.props.style },
	 ...
	 */
                ...
                exports.Breadcrumb = function(breadcrumbProps) {
                    var classes = classNames(
                        Classes.BREADCRUMB,
                        ((_a = {}), (_a[Classes.DISABLED] = breadcrumbProps.disabled), _a),
	 ...
	 */
                ...
                var Callout = (function(_super) {
                    ...
                    Callout.prototype.render = function() {
                        ...
                        return React.createElement(
                            "div",
                            tslib_1.__assign({ className: classes }, htmlProps),
	 ...
	 */
                ...
                var Card = (function(_super) {
                    ...
                    Card.prototype.getClassName = function() {
                        ...
                        return classNames(
                            Classes.CARD,
                            ((_b = {}), (_b[Classes.INTERACTIVE] = interactive), _b),
	 ...
	 */
                ...
                var menuItem_1 = __webpack_require__(50);
                var popover_1 = __webpack_require__(26);
                var CollapseFrom;
                ...
                var CollapsibleList = (function(_super) {
                    ...
                    CollapsibleList.prototype.render = function() {
                        ...
                        var visibleItems = visibleChildren.map(function(child, index) {
                            ...
                            return React.createElement(
                                "li",
                                { className: _this.props.visibleItemClassName, key: absoluteIndex },
                        ...
                        if (collapsedChildren.length > 0) {
                            var position =
                                collapseFrom === CollapseFrom.END ? position_1.Position.BOTTOM_RIGHT : position_1.Position.BOTTOM_LEFT;
                            collapsedPopover = React.createElement(
                                "li",
                                { className: this.props.visibleItemClassName },
                                React.createElement(
                                    popover_1.Popover,
                                    tslib_1.__assign(
                                        { content: React.createElement(menu_1.Menu, null, collapsedChildren), position: position },
	 ...
	 */
                ...
                var Menu = (function(_super) {
                    ...
                    Menu.prototype.render = function() {
                        return React.createElement(
                            "ul",
                            { className: classNames(Classes.MENU, this.props.className), ref: this.props.ulRef },
                            this.props.children
                        );
                    };
                    return Menu;
                    ...
                    MenuItem.prototype.render = function() {
                        ...
                        if (hasSubmenu) {
                            ...
                            var popoverClasses = classNames(
                                ...
                                ((_d = {}), (_d[Classes.ALIGN_LEFT] = this.state.alignLeft), _d)
                            );
                            content = React.createElement(
                                ...
                                tslib_1.__assign(
                                    ...
                                    popoverProps,
                                    { content: submenuElement, popoverClassName: popoverClasses }
                                ),
                                content
                            );
                        }
	 ...
	 */
                ...
                var Keys = __webpack_require__(18);
                var utils_1 = __webpack_require__(8);
                var compatibility_1 = __webpack_require__(53);
                ...
                var EditableText = (function(_super) {
                    ...
                    EditableText.prototype.render = function() {
                        ...
                        return React.createElement(
                            "div",
                            { className: classes, onFocus: this.handleFocus, tabIndex: tabIndex },
                            this.maybeRenderInput(value),
                            React.createElement(
                                "span",
                                { className: "pt-editable-content", ref: this.refHandlers.content, style: contentStyle },
                    ...
                    EditableText.prototype.maybeRenderInput = function(value) {
                        ...
                        return multiline
                            ? React.createElement("textarea", tslib_1.__assign({}, props))
                            : React.createElement("input", tslib_1.__assign({ type: "text" }, props));
                    };
                ...
                var Control = (function(_super) {
                    ...
                    Control.prototype.renderControl = function(type, typeClassName, inputRef) {
                        ...
                        var className = classNames(
                            Classes.CONTROL,
                            typeClassName,
                            ((_a = {}), (_a[Classes.DISABLED] = this.props.disabled), (_a[Classes.INLINE] = this.props.inline), _a),
                            this.props.className
                        );
                ...
                var FormGroup = (FormGroup_1 = (function(_super) {
                    ...
                    FormGroup.prototype.render = function() {
                        ...
                        return React.createElement(
                            ...
                            React.createElement(
                                "label",
                                { className: Classes.LABEL, htmlFor: labelFor },
                                label,
                                this.maybeRenderRequiredLabel()
                            ),
                            React.createElement("div", { className: Classes.FORM_CONTENT }, children, this.maybeRenderHelperText())
                        );
                    };
                    FormGroup.prototype.getClassName = function() {
                        ...
                        return classNames(
                            Classes.FORM_GROUP,
                            Classes.intentClass(intent),
                            ((_b = {}), (_b[Classes.DISABLED] = disabled), (_b[Classes.INLINE] = inline), _b),
                            className
                        );
                        var _b;
                    };
                ...
                var InputGroup = (function(_super) {
                    ...
                    InputGroup.prototype.render = function() {
                        ...
                        var classes = classNames(
                            Classes.INPUT_GROUP,
                            Classes.intentClass(intent),
                            ((_b = {}), (_b[Classes.DISABLED] = this.props.disabled), _b),
                            className
                        );
                        ...
                        return React.createElement(
                            ...
                            React.createElement(
                                "input",
                                tslib_1.__assign({ type: "text" }, props_1.removeNonHTMLProps(this.props), {
                    ...
                    InputGroup.prototype.maybeRenderRightElement = function() {
                        ...
                        return React.createElement(
                            "span",
                            { className: "pt-input-action", ref: this.refHandlers.rightElement },
                            rightElement
                        );
                    };
	 ...
	 */
                ...
                var Errors = __webpack_require__(10);
                var buttons_1 = __webpack_require__(39);
                var inputGroup_1 = __webpack_require__(57);
                ...
                var NumericInput = (NumericInput_1 = (function(_super) {
                    ...
                    NumericInput.prototype.render = function() {
                        var _a = this.props,
                            ...
                            className = _a.className,
                            large = _a.large;
                        var inputGroupHtmlProps = common_1.removeNonHTMLProps(
                            this.props,
                            [
                        ...
                        var inputGroup = React.createElement(
                            inputGroup_1.InputGroup,
                            tslib_1.__assign({ autoComplete: "off" }, inputGroupHtmlProps, {
                        ...
                        if (buttonPosition === "none" || buttonPosition === null) {
                            ...
                            var incrementButton = this.renderButton(
                                NumericInput_1.INCREMENT_KEY,
                                NumericInput_1.INCREMENT_ICON_NAME,
                                this.handleIncrementButtonClick
                            );
                            var decrementButton = this.renderButton(
                                NumericInput_1.DECREMENT_KEY,
                                NumericInput_1.DECREMENT_ICON_NAME,
                            ...
                            var inputElems =
                                buttonPosition === common_1.Position.LEFT ? [buttonGroup, inputGroup] : [inputGroup, buttonGroup];
                            var classes = classNames(
                                common_1.Classes.NUMERIC_INPUT,
                                common_1.Classes.CONTROL_GROUP,
                                ((_c = {}), (_c[common_1.Classes.LARGE] = large), _c),
                                className
                            );
	 ...
	 */
                ...
                var Classes = __webpack_require__(17);
                var Errors = __webpack_require__(10);
                var controls_1 = __webpack_require__(55);
                var counter = 0;
                function nextName() {
                ...
                var RadioGroup = (function(_super) {
                    ...
                    RadioGroup.prototype.renderOptions = function() {
                        ...
                        return this.props.options.map(function(option) {
                            return React.createElement(
                                controls_1.Radio,
                                tslib_1.__assign({}, option, _this.getRadioProps(option), { key: option.value })
                            );
                        });
                    };
	 ...
	 */
                ...
                var common_1 = __webpack_require__(4);
                var errors_1 = __webpack_require__(10);
                var hotkey_1 = __webpack_require__(61);
                var hotkey_2 = __webpack_require__(61);
                exports.Hotkey = hotkey_2.Hotkey;
                var keyCombo_1 = __webpack_require__(62);
                exports.KeyCombo = keyCombo_1.KeyCombo;
                var hotkeysTarget_1 = __webpack_require__(64);
                exports.HotkeysTarget = hotkeysTarget_1.HotkeysTarget;
                var hotkeyParser_1 = __webpack_require__(63);
                ...
                var hotkeysDialog_1 = __webpack_require__(66);
                    ...
                    Hotkeys.prototype.render = function() {
                        ...
                        for (var _i = 0, hotkeys_1 = hotkeys; _i < hotkeys_1.length; _i++) {
                            ...
                            if (groupLabel !== lastGroup) {
                                elems.push(
                                    React.createElement("h4", { key: "group-" + elems.length, className: "pt-hotkey-group" }, groupLabel)
                                );
                        ...
                        for (var i = 0; i < keys.length; i++) {
                            ...
                            if (icon != null) {
                                components.push(
                                    React.createElement(
                                        "kbd",
                                        { className: "pt-key pt-modifier-key", key: "key-" + i },
	 ...
	 */
                ...
                var React = __webpack_require__(7);
                var utils_1 = __webpack_require__(8);
                var hotkeysEvents_1 = __webpack_require__(65);
                        ...
                        this.handleKeyDown = function(e) {
                            ...
                            if (!isTextInput && hotkeyParser_1.comboMatches(hotkeyParser_1.parseKeyCombo(SHOW_DIALOG_KEY), combo)) {
                                if (hotkeysDialog_1.isHotkeysDialogShowing()) {
                                    ...
                                    hotkeysDialog_1.showHotkeysDialog(
	 ...
	 */
                ...
                var HotkeysDialog = (function() {
                    ...
                    HotkeysDialog.prototype.renderComponent = function() {
                        return React.createElement(
                            components_1.Dialog,
                            tslib_1.__assign({}, this.componentProps, {
                    ...
                    HotkeysDialog.prototype.renderHotkeys = function() {
                        ...
                        var elements = hotkeys.map(function(hotkey, index) {
                            var group =
                                hotkey.global === true && hotkey.group == null ? _this.componentProps.globalHotkeysGroup : hotkey.group;
	 ...
	 */
                ...
                var NonIdealState = (function(_super) {
                    ...
                    NonIdealState.prototype.render = function() {
                        return React.createElement(
                            "div",
                            { className: classNames(Classes.NON_IDEAL_STATE, this.props.className) },
                    ...
                    NonIdealState.prototype.maybeRenderVisual = function() {
                        ...
                        if (visual == null) {
                            ...
                            return React.createElement(
                                "div",
                                { className: classNames(Classes.NON_IDEAL_STATE_VISUAL, Classes.NON_IDEAL_STATE_ICON) },
	 ...
	 */
                ...
                var Text = (function(_super) {
                    ...
                    Text.prototype.render = function() {
                        var classes = classNames(
                            ((_a = {}), (_a[Classes.TEXT_OVERFLOW_ELLIPSIS] = this.props.ellipsize), _a),
                            this.props.className
                        );
                        return React.createElement(
                            "div",
	 ...
	 */
                ...
                var SVGPopover = (function(_super) {
                    ...
                    SVGPopover.prototype.render = function() {
                        return React.createElement(
                            popover_1.Popover,
                            tslib_1.__assign({ rootElementTag: "g" }, this.props),
                            this.props.children
                        );
                    };
                    return SVGPopover;
	 ...
	 */
                ...
                var Errors = __webpack_require__(10);
                var utils_1 = __webpack_require__(8);
                var coreSlider_1 = __webpack_require__(74);
                var handle_1 = __webpack_require__(75);
                var RangeIndex;
                (function(RangeIndex) {
	 ...
	 */
                ...
                var CoreSlider = (function(_super) {
                    ...
                    CoreSlider.prototype.render = function() {
                        ...
                        return React.createElement(
                            "div",
                            { className: classes, onMouseDown: this.maybeHandleTrackClick, onTouchStart: this.maybeHandleTrackTouch },
                    ...
                    CoreSlider.prototype.maybeRenderAxis = function() {
                        ...
                        for (var i = min, offset = 0; i < max || utils_1.approxEqual(i, max); i += labelStepSize, offset += stepSize) {
                            ...
                            labels.push(
                                React.createElement(
                                    "div",
                                    { className: Classes.SLIDER + "-label", key: i, style: style },
                                    this.formatLabel(i)
                                )
                            );
                        }
	 ...
	 */
                ...
                var Slider = (function(_super) {
                    ...
                    Slider.prototype.renderHandles = function() {
                        ...
                        return React.createElement(
                            handle_1.Handle,
                            tslib_1.__assign({}, this.props, this.state, {
                                className: "",
	 ...
	 */
                ...
                var spinner = __webpack_require__(42);
                var SVGSpinner = (function(_super) {
                    ...
                    SVGSpinner.prototype.renderContainer = function(classes, content) {
                        return React.createElement(
                            "g",
                            { className: classNames(Classes.SVG_SPINNER, classes) },
	 ...
	 */
                ...
                var Keys = __webpack_require__(18);
                var Utils = __webpack_require__(8);
                var tab_1 = __webpack_require__(78);
                var tabList_1 = __webpack_require__(80);
                var tabPanel_1 = __webpack_require__(81);
	 ...
	 */
                ...
                var TabList = (function(_super) {
                    ...
                    TabList.prototype.render = function() {
                        return React.createElement(
                            "ul",
                            { className: classNames(Classes.TAB_LIST, this.props.className), role: "tablist" },
                            React.createElement(
                                "div",
                                {
	 ...
	 */
                ...
                var Keys = __webpack_require__(18);
                var Utils = __webpack_require__(8);
                var tab2_1 = __webpack_require__(82);
                var tabTitle_1 = __webpack_require__(84);
                ...
                var Tabs2 = (function(_super) {
                    ...
                    Tabs2.prototype.render = function() {
                        ...
                        var tabIndicator = this.props.animate
                            ? React.createElement(
                                  "div",
                                  { className: "pt-tab-indicator-wrapper", style: indicatorWrapperStyle },
                                  React.createElement("div", { className: "pt-tab-indicator" })
                              )
                            : undefined;
                        var classes = classNames(
                            Classes.TABS,
                            ((_b = {}), (_b[Classes.VERTICAL] = this.props.vertical), _b),
                            this.props.className
                        );
                    ...
                    Tabs2.prototype.componentDidUpdate = function(prevProps, prevState) {
                        if (this.state.selectedTabId !== prevState.selectedTabId) {
                            ...
                            var didChildrenChange = !Utils.arraysEqual(
                ...
                var Tag = (function(_super) {
                    ...
                    Tag.prototype.render = function() {
                        ...
                        var tagClasses = classNames(
                            Classes.TAG,
                            Classes.intentClass(intent),
                            ((_b = {}), (_b[Classes.TAG_REMOVABLE] = onRemove != null), (_b[Classes.ACTIVE] = active), _b),
                            className
                        );
                        ...
                        return React.createElement(
                            "span",
                            tslib_1.__assign({}, props_1.removeNonHTMLProps(this.props), { className: tagClasses }),
                            this.props.children,
                            button
                        );
                        var _b;
                ...
                var Toast = (function(_super) {
                    ...
                    Toast.prototype.maybeRenderActionButton = function() {
                        ...
                        if (action == null) {
                            ...
                            return React.createElement(
                                buttons_1.AnchorButton,
                                tslib_1.__assign({}, action, { intent: undefined, onClick: this.handleActionClick })
                            );
                        }
                    };
	 ...
	 */
                ...
                var utils_1 = __webpack_require__(8);
                var overlay_1 = __webpack_require__(33);
                var toast_1 = __webpack_require__(86);
                var Toaster = (Toaster_1 = (function(_super) {
                    ...
                    Toaster.create = function(props, container) {
                        ...
                        return ReactDOM.render(
                            React.createElement(Toaster_1, tslib_1.__assign({}, props, { inline: true })),
                            containerElement
                        );
                    };
                    ...
                    Toaster.prototype.renderToast = function(toast) {
                        return React.createElement(
                            toast_1.Toast,
                            tslib_1.__assign({}, toast, { onDismiss: this.getDismissHandler(toast) })
                        );
                    };
	 ...
	 */
                ...
                var Classes = __webpack_require__(17);
                var utils_1 = __webpack_require__(8);
                var treeNode_1 = __webpack_require__(89);
                ...
                var TreeNode = (function(_super) {
                    ...
                    TreeNode.prototype.render = function() {
                        ...
                        var caretClasses = classNames(
                            ...
                            ((_b = {}), (_b[caretStateClass] = showCaret), _b)
                        );
                        var classes = classNames(
                            Classes.TREE_NODE,
                            ((_c = {}), (_c[Classes.TREE_NODE_SELECTED] = isSelected), (_c[Classes.TREE_NODE_EXPANDED] = isExpanded), _c),
                            className
                        );
