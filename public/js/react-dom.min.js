...
(function(na, l) {
    "object" === typeof exports && "undefined" !== typeof module
        ...
        : "function" === typeof define && define.amd ? define(["react"], l) : (na.ReactDOM = l(na.React));
})(this, function(na) {
    function l(a) {
        for (
    ...
    function Xc(a, b) {
        if (Yc.hasOwnProperty(a) || (2 < a.length && ("o" === a[0] || "O" === a[0]) && ("n" === a[1] || "N" === a[1]))) return !1;
        if (null === b) return !0;
        switch (typeof b) {
            case "boolean":
                return (
                    Yc.hasOwnProperty(a)
                        ? (a = !0)
                        : (b = Ub(a))
                          ? (a = b.hasBooleanValue || b.hasStringBooleanValue || b.hasOverloadedBooleanValue)
                          : ((a = a.toLowerCase().slice(0, 5)), (a = "data-" === a || "aria-" === a)),
                    a
                );
            case "undefined":
            case "number":
                ...
                if (!oa[c]) {
                    ...
                    for (var d in c) {
                        ...
                        if (k) {
                            ...
                            e = !0;
                        } else f.registrationName ? ($c(f.registrationName, g, h), (e = !0)) : (e = !1);
                        e ? void 0 : l("98", d, a);
                    }
                }
            }
    ...
    function kf(a, b) {
        if (za)
            return "topCompositionEnd" === a || (!bc && pd(a, b))
                ? ((a = kd()), (H._root = null), (H._startText = null), (H._fallbackText = null), (za = !1), a)
                : null;
        switch (a) {
            case "topPaste":
                return null;
    ...
    function yf(a) {
        ...
        for (c = 0; c < a.ancestors.length; c++) (b = a.ancestors[c]), pb(a.topLevelType, b, a.nativeEvent, fc(a.nativeEvent));
    }
    function ic(a) {
        Ra = !!a;
    }
        ...
        return a && b
            ? a === b
              ...
              : Od(a)
                ...
                : Od(b)
                  ? Nd(a, b.parentNode)
                  : "contains" in a ? a.contains(b) : a.compareDocumentPosition ? !!(a.compareDocumentPosition(b) & 16) : !1
            : !1;
    }
    function Pd(a) {
    ...
    function yb(a, b, c) {
        ...
        null === d
            ? ((d = new Q(a.tag, a.key, a.internalContextTag)),
              ...
              (d.alternate = a),
              (a.alternate = d))
            : ((d.effectTag = 0), (d.nextEffect = null), (d.firstEffect = null), (d.lastEffect = null));
        d.expirationTime = c;
        d.pendingProps = b;
        d.child = a.child;
    ...
    function qc(a, b, c) {
        var d = void 0,
            ...
            f = a.key;
        "function" === typeof e
            ? ((d = e.prototype && e.prototype.isReactComponent ? new Q(2, f, b) : new Q(0, f, b)),
              (d.type = e),
    ...
    function xc(a, b, c, d, e, f) {
        ...
        for (var g = !0, h = c.first, k = !1; null !== h; ) {
            ...
            if (l > f) {
                ...
                else if ((l = ie(h, d, a, e))) (a = g ? C({}, a, l) : C(a, l)), (g = !1);
    ...
    function Cb(a, b) {
        "textarea" !== a.type &&
            l(
                "31",
                "[object Object]" === Object.prototype.toString.call(b) ? "object with keys {" + Object.keys(b).join(", ") + "}" : b,
                ""
            );
    }
    function le(a) {
        ...
        function h(a, b, c, d) {
            if (null === b || 6 !== b.tag) return (b = rc(c, a.internalContextTag, d)), (b["return"] = a), b;
            b = e(b, c, d);
            b["return"] = a;
            return b;
        }
        ...
        function m(a, b, c, d) {
            if (null === b || 7 !== b.tag) return (b = sc(c, a.internalContextTag, d)), (b["return"] = a), b;
            b = e(b, c, d);
            b["return"] = a;
            return b;
        }
        function D(a, b, c, d) {
            if (null === b || 9 !== b.tag) return (b = tc(c, a.internalContextTag, d)), (b.type = c.value), (b["return"] = a), b;
            b = e(b, null, d);
            b.type = c.value;
            b["return"] = a;
            return b;
        ...
        function v(a, b, c, d, g) {
            if (null === b || 10 !== b.tag) return (b = zb(c, a.internalContextTag, d, g)), (b["return"] = a), b;
            b = e(b, c, d);
            b["return"] = a;
            return b;
        }
        function K(a, b, c) {
            if ("string" === typeof b || "number" === typeof b) return (b = rc("" + b, a.internalContextTag, c)), (b["return"] = a), b;
            if ("object" === typeof b && null !== b) {
                switch (b.$$typeof) {
                    case Db:
                        if (b.type === sa) return (b = zb(b.props.children, a.internalContextTag, c, b.key)), (b["return"] = a), b;
                ...
                if (Gb(b) || Wa(b)) return (b = zb(b, a.internalContextTag, c, null)), (b["return"] = a), b;
                Cb(a, b);
            }
            return null;
        }
                ...
                switch (d.$$typeof) {
                    case Db:
                        return (
                            ...
                            d.type === sa ? v(b, a, d.props.children, e, d.key) : k(b, a, d, e)
                        );
                    case Eb:
        ...
        function n(e, g, h, z) {
            ...
            if (null === p) {
                for (; x < h.length; x++) if ((p = K(e, h[x], z))) (g = f(p, g, x)), null === q ? (t = p) : (q.sibling = p), (q = p);
                return t;
            }
            for (p = d(e, p); x < h.length; x++)
                if ((k = R(p, e, x, h[x], z))) {
                    if (a && null !== k.alternate) p["delete"](null === k.key ? x : k.key);
                    g = f(k, g, x);
        ...
        function r(e, g, h, z) {
            ...
            h = t.call(h);
            null == h ? l("151") : void 0;
            for (var q = (t = null), p = g, x = (g = 0), k = null, m = h.next(); null !== p && !m.done; x++, m = h.next()) {
                p.index > x ? ((k = p), (p = null)) : (k = p.sibling);
        ...
        return function(a, d, f, h) {
                ...
                switch (f.$$typeof) {
                    case Db:
                        a: {
                            ...
                            f.type === sa
                                ? ((d = zb(f.props.children, a.internalContextTag, h, f.key)), (d["return"] = a), (a = d))
                                : ((h = qc(f, a.internalContextTag, h)), (h.ref = Xa(d, f)), (h["return"] = a), (a = h));
                        }
                        return g(a);
                    case Eb:
                        a: {
            ...
            if ("string" === typeof f || "number" === typeof f)
                return (
                    (f = "" + f),
                    null !== d && 6 === d.tag ? (c(a, d.sibling), (d = e(d, f, h))) : (c(a, d), (d = rc(f, a.internalContextTag, h))),
                    (d["return"] = a),
                    (a = d),
                    g(a)
                );
    ...
    function oe(a, b) {
        ...
        c
            ? (b = c.mutationMethod)
              ? b(a, void 0)
              : c.mustUseProperty ? (a[c.propertyName] = c.hasBooleanValue ? !1 : "") : a.removeAttribute(c.attributeName)
            : a.removeAttribute(b);
    }
    function Bc(a, b) {
        var c = b.value,
    ...
    function Ec(a, b) {
        ...
        return C({}, b, { value: void 0, defaultValue: void 0, children: "" + a._wrapperState.initialValue });
    }
    function te(a, b) {
        var c = b.value;
        null == c &&
            ((c = b.defaultValue),
            (b = b.children),
            null != b && (null != c ? l("92") : void 0, Array.isArray(b) && (1 >= b.length ? void 0 : l("93"), (b = b[0])), (c = "" + b)),
            null == c && (c = ""));
        a._wrapperState = {
            initialValue: "" + c
        };
    ...
    function Fc(a, b) {
        return null == a || "http://www.w3.org/1999/xhtml" === a
            ? ve(b)
            : "http://www.w3.org/2000/svg" === a && "foreignObject" === b ? "http://www.w3.org/1999/xhtml" : a;
    }
    function we(a, b, c) {
        a = a.style;
        for (var d in b)
            if (b.hasOwnProperty(d)) {
                ...
                e =
                    null == f || "boolean" === typeof f || "" === f
                        ? ""
                        : c || "number" !== typeof f || 0 === f || (Za.hasOwnProperty(e) && Za[e]) ? ("" + f).trim() : f + "px";
                "float" === d && (d = "cssFloat");
    ...
    function Gc(a, b, c) {
        b &&
            (Ff[a] && (null != b.children || null != b.dangerouslySetInnerHTML ? l("137", a, c()) : void 0),
            null != b.dangerouslySetInnerHTML &&
                (null != b.children ? l("60") : void 0,
                "object" === typeof b.dangerouslySetInnerHTML && "__html" in b.dangerouslySetInnerHTML ? void 0 : l("61")),
            ...
            (c.hasOwnProperty(e) && c[e]) ||
                ("topScroll" === e
                    ...
                    : "topFocus" === e || "topBlur" === e
                      ? (ha("topFocus", "focus", a), ha("topBlur", "blur", a), (c.topBlur = !0), (c.topFocus = !0))
                      : "topCancel" === e
                        ? (gc("cancel", !0) && ha("topCancel", "cancel", a), (c.topCancel = !0))
                        : "topClose" === e
                          ? (gc("close", !0) && ha("topClose", "close", a), (c.topClose = !0))
    ...
    function ye(a, b, c, d) {
        ...
        "http://www.w3.org/1999/xhtml" === d
            ? "script" === a
              ? ((a = c.createElement("div")), (a.innerHTML = "\x3cscript\x3e\x3c/script\x3e"), (a = a.removeChild(a.firstChild)))
            ...
            if (g.hasOwnProperty(h)) {
                ...
                "style" === h
                    ...
                    : "dangerouslySetInnerHTML" === h
                      ...
                      : "children" === h
                        ? "string" === typeof k ? ("textarea" !== b || "" !== k) && Ic(a, k) : "number" === typeof k && Ic(a, "" + k)
                        : "suppressContentEditableWarning" !== h &&
                          "suppressHydrationWarning" !== h &&
                          "autoFocus" !== h &&
                          (ca.hasOwnProperty(h) ? null != k && Y(d, h) : e ? Ac(a, h, k) : null != k && zc(a, h, k));
            }
        switch (b) {
            case "input":
                nb(a);
    ...
    function Ce(a, b, c, d, e) {
        ...
        for (g in c)
            if (!d.hasOwnProperty(g) && c.hasOwnProperty(g) && null != c[g])
                if ("style" === g) for (h in ((b = c[g]), b)) b.hasOwnProperty(h) && (a || (a = {}), (a[h] = ""));
                else
                    "dangerouslySetInnerHTML" !== g &&
                        ...
                        "autoFocus" !== g &&
                        (ca.hasOwnProperty(g) ? f || (f = []) : (f = f || []).push(g, null));
        for (g in d) {
            var k = d[g];
            b = null != c ? c[g] : void 0;
            if (d.hasOwnProperty(g) && k !== b && (null != k || null != b))
                if ("style" === g)
                    ...
                    "dangerouslySetInnerHTML" === g
                        ? ((k = k ? k.__html : void 0), (b = b ? b.__html : void 0), null != k && b !== k && (f = f || []).push(g, "" + k))
                        : "children" === g
                          ? b === k || ("string" !== typeof k && "number" !== typeof k) || (f = f || []).push(g, "" + k)
                          : "suppressContentEditableWarning" !== g &&
                            "suppressHydrationWarning" !== g &&
                            (ca.hasOwnProperty(g) ? (null != k && Y(e, g), f || b === k || (f = [])) : (f = f || []).push(g, k));
        }
        a && (f = f || []).push("style", a);
        return f;
    }
    function De(a, b, c, d, e) {
        ...
        for (var f = 0; f < b.length; f += 2) {
            ...
            "style" === g
                ...
                : "dangerouslySetInnerHTML" === g
                  ? Be(a, h)
                  : "children" === g ? Ic(a, h) : d ? (null != h ? Ac(a, g, h) : a.removeAttribute(g)) : null != h ? zc(a, g, h) : oe(a, g);
        }
        switch (c) {
            case "input":
                Cc(a, e);
            ...
            DOMMutationMethods: {
                value: function(a, b) {
                    ...
                    "number" !== a.type || !1 === a.hasAttribute("value")
                        ...
                        : a.validity && !a.validity.badInput && a.ownerDocument.activeElement !== a && a.setAttribute("value", "" + b);
                }
            }
        },
        Kc = aa.HAS_STRING_BOOLEAN_VALUE,
        Lc = {
            Properties: { autoReverse: Kc, externalResourcesRequired: Kc, preserveAlpha: Kc },
            DOMAttributeNames: {
    ...
    var G = ta,
        ...
        Me = function(a, b) {
            if (a) {
                ...
                if (Array.isArray(c)) for (var e = 0; e < c.length && !a.isPropagationStopped(); e++) cd(a, b, c[e], d[e]);
                else c && cd(a, b, c, d);
    ...
    var Pf = P.canUseDOM && "TextEvent" in window && !ab && !gf(),
        ...
        Qf = {
            ...
            extractEvents: function(a, b, c, d) {
                ...
                else za ? pd(a, c) && (f = V.compositionEnd) : "topKeyDown" === a && 229 === c.keyCode && (f = V.compositionStart);
                f
                    ? (td &&
        ...
        zd;
    P.canUseDOM &&
        (zd = document.implementation && document.implementation.hasFeature && !0 !== document.implementation.hasFeature("", ""));
    var Dd = {
            change: {
    ...
    var Sf = {
        ...
        extractEvents: function(a, b, c, d) {
            ...
            else (f = e.nodeName), !f || "input" !== f.toLowerCase() || ("checkbox" !== e.type && "radio" !== e.type) || (g = rf);
            ...
            "topBlur" === a &&
                ...
                a.controlled &&
                "number" === e.type &&
                ((a = "" + e.value), e.getAttribute("value") !== a && e.setAttribute("value", a));
        }
    };
    n.augmentClass(Aa, { view: null, detail: null });
    var uf = { Alt: "altKey", Control: "ctrlKey", Meta: "metaKey", Shift: "shiftKey" };
    Aa.augmentClass(qa, {
        screenX: null,
        screenY: null,
        clientX: null,
    ...
    P.canUseDOM &&
        ...
        "AnimationEvent" in window ||
            (delete U.animationend.animation, delete U.animationiteration.animation, delete U.animationstart.animation),
    ...
    var xe = {
        ...
        oc = function(a, b) {
            ...
            for (d = 0; d < c.length; d++) if (!Vf.call(b, c[d]) || !Md(a[c[d]], b[c[d]])) return !1;
            return !0;
        },
        Od = function(a) {
            ...
            return (
                !!(
                    ...
                    ("function" === typeof b.Node
                        ? a instanceof b.Node
                        : "object" === typeof a && "number" === typeof a.nodeType && "string" === typeof a.nodeName)
                ) && 3 == a.nodeType
            );
        },
        ...
        Xf = {
            ...
            extractEvents: function(a, b, c, d) {
                ...
                switch (a) {
                    case "topFocus":
                        if (yd(e) || "true" === e.contentEditable) (X = e), (pc = b), (Sa = null);
                        break;
                    case "topBlur":
                        Sa = pc = X = null;
                        break;
    ...
    n.augmentClass(Td, { animationName: null, elapsedTime: null, pseudoElement: null });
    n.augmentClass(Ud, {
    ...
    Aa.augmentClass(Wd, {
        key: function(a) {
            ...
            return "keypress" === a.type
                ...
                : "keydown" === a.type || "keyup" === a.type ? Zf[a.keyCode] || "Unidentified" : "";
        },
        location: null,
        ctrlKey: null,
        shiftKey: null,
    ...
    n.augmentClass(Zd, { propertyName: null, elapsedTime: null, pseudoElement: null });
    qa.augmentClass($d, {
        deltaX: function(a) {
    ...
    var ia = { current: ja },
        ...
        ag = function(a, b, c, d) {
            ...
            var f = {
                ...
                enqueueSetState: function(c, d, e) {
                    ...
                    e = void 0 === e ? null : e;
                    var f = b(c);
                    Bb(c, { expirationTime: f, partialState: d, callback: e, isReplace: !1, isForced: !1, nextCallback: null, next: null });
                    a(c, f);
                },
            ...
            return {
                ...
                updateClassInstance: function(a, b, e) {
                    ...
                    "function" !== typeof g.componentWillReceiveProps ||
                        (h === k && v === K) ||
                        ((v = g.state), g.componentWillReceiveProps(k, K), g.state !== v && f.enqueueReplaceState(g, g.state, null));
                    v = b.memoizedState;
                    ...
                    var L = k;
                    if (null === h || (null !== b.updateQueue && b.updateQueue.hasForceUpdate)) L = !0;
                    else {
                        var R = b.stateNode,
                            n = b.type;
                        L =
                            "function" === typeof R.shouldComponentUpdate
                                ...
                                : n.prototype && n.prototype.isPureReactComponent ? !oc(h, L) || !oc(v, e) : !0;
                    }
                    L
                        ? ("function" === typeof g.componentWillUpdate && g.componentWillUpdate(k, e, K),
                    ...
                    switch (b.tag) {
                        case 0:
                            ...
                            "object" === typeof d && null !== d && "function" === typeof d.render
                                ? ((b.tag = 2), (e = xb(b)), x(b, d), z(b, c), (b = h(a, b, !0, e)))
                                : ((b.tag = 1), f(a, b, d), (b.memoizedProps = e), (b = b.child));
                            return b;
                        case 1:
                            a: {
                                e = b.type;
                        ...
                        case 2:
                            return (
                                (e = xb(b)),
                                (d = void 0),
                                null === a ? (b.stateNode ? l("153") : (t(b, b.pendingProps), z(b, c), (d = !0))) : (d = yc(a, b, c)),
                                h(a, b, d, e)
                            );
                        case 3:
                            return (
                        ...
                        case 6:
                            return (
                                null === a && y(b), (a = b.pendingProps), null === a && (a = b.memoizedProps), (b.memoizedProps = a), null
                            );
                        case 8:
                            b.tag = 7;
                        case 7:
                            e = b.pendingProps;
                            if (J.current) null === e && ((e = a && a.memoizedProps), null === e ? l("154") : void 0);
        ...
        cg = function(a, b, c) {
            ...
            return {
                completeWork: function(a, b, c) {
                    ...
                    else if (2147483647 !== b.expirationTime || 2147483647 === c) b.pendingProps = null;
                    switch (b.tag) {
                        case 1:
                            return null;
                        case 2:
                        ...
                        case 6:
                            if (a && null != b.stateNode) x(a, b, a.memoizedProps, t);
                                ...
                                if ("string" !== typeof t) return null === b.stateNode ? l("166") : void 0, null;
                                a = D();
                                c = v();
        ...
        dg = function(a, b) {
            ...
            function g(a) {
                for (var b = a, c = !1, f = void 0, g = void 0; ; ) {
                    ...
                    if (5 === b.tag || 6 === b.tag) e(b), g ? y(f, b.stateNode) : w(f, b.stateNode);
        ...
        fg = function(a) {
            ...
            return {
                ...
                popHydrationState: function(a) {
                    ...
                    var c = a.type;
                    if (5 !== a.tag || ("head" !== c && "body" !== c && !e(c, a.memoizedProps))) for (c = v; c; ) b(a, c), (c = h(c));
                    d(a);
        ...
        gg = function(a) {
                        ...
                        for (; null !== u; ) {
                            ...
                            if (k & 64)
                                ...
                                null !== S &&
                                    ((f = S.get(e)),
                                    S["delete"](e),
                                    null == f && null !== e.alternate && ((e = e.alternate), (f = S.get(e)), S["delete"](e))),
                                null == f ? l("184") : void 0,
                                e.tag)) {
                                    case 2:
            ...
            function c(a) {
                for (;;) {
                    ...
                    null !== c &&
                        ...
                        null !== a.lastEffect &&
                            (null !== c.lastEffect && (c.lastEffect.nextEffect = a.firstEffect), (c.lastEffect = a.lastEffect)),
                        1 < a.effectTag &&
                            (null !== c.lastEffect ? (c.lastEffect.nextEffect = a) : (c.firstEffect = a), (c.lastEffect = a)));
                    if (null !== d) return d;
                    if (null !== c) a = c;
                    else {
            ...
            function h(a, b) {
                ...
                if (3 === a.tag) (c = a), m(a) && (U = !0);
                    ...
                    for (var g = a["return"]; null !== g && null === c; ) {
                        2 === g.tag
                            ? "function" === typeof g.stateNode.componentDidCatch && ((d = !0), (f = Pa(g)), (c = g), (e = !0))
                            : 3 === g.tag && (c = g);
                        if (m(g)) {
                            if (ka || (null !== ua && (ua.has(g) || (null !== g.alternate && ua.has(g.alternate))))) return null;
                            c = null;
                            e = !1;
                        }
                        g = g["return"];
                        ...
                        a: switch (g.tag) {
                            ...
                            case 5:
                                ...
                                Ma =
                                    ...
                                    (Ma || "Unknown") +
                                    (k
                                        ? " (at " + k.fileName.replace(/^.*[\\\/]/, "") + ":" + k.lineNumber + ")"
                                        : p ? " (created by " + p + ")" : "");
                                break a;
                            default:
                                Ma = "";
                            ...
                            if (null === d.nextScheduledRoot)
                                (d.remainingExpirationTime = e),
                                    null === N
                                        ...
                                        : ((N = N.nextScheduledRoot = d), (N.nextScheduledRoot = Ka));
                            else {
                    ...
                    for (var c = N, d = Ka; null !== d; ) {
                        ...
                        if (0 === e) {
                            ...
                            if (d === d.nextScheduledRoot) {
                                ...
                                break;
                            } else if (d === Ka) (Ka = e = d.nextScheduledRoot), (N.nextScheduledRoot = e), (d.nextScheduledRoot = null);
                            else if (d === N) {
                                N = c;
            ...
            function x(a, b) {
                W = b;
                for (E(); null !== Ea && 0 !== Fa && (0 === a || Fa <= a) && !oa; ) t(Ea, Fa), E();
                null !== W && ((Z = 0), (la = -1));
                0 !== Fa && C(Fa);
                W = null;
                oa = !1;
            ...
            function t(a, c) {
                ...
                if (c <= y()) {
                    ...
                    null !== d
                        ...
                        : ((a.finishedWork = null), (d = g(a, c)), null !== d && (a.remainingExpirationTime = b(d)));
                } else
                    (d = a.finishedWork),
                        null !== d
                            ? ((a.finishedWork = null), (a.remainingExpirationTime = b(d)))
                            : ((a.finishedWork = null),
                              (d = g(a, c)),
                              null !== d && (z() ? (a.finishedWork = d) : (a.remainingExpirationTime = b(d))));
                Na = !1;
            }
            function z() {
        ...
        Te = function(a) {
            ...
            return {
                ...
                updateContainer: function(a, b, c, m) {
                    ...
                    b = void 0 === b ? null : b;
                    m =
                        null != a && null != a.type && null != a.type.prototype && !0 === a.type.prototype.unstable_isAsyncReactComponent
                            ? d()
                            : e(g);
                    Bb(g, {
                        expirationTime: m,
    ...
    E.injectIntoDevTools({ findFiberByHostInstance: W, bundleType: 0, version: "16.2.0", rendererPackageName: "react-dom" });
